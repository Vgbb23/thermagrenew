...
const CHECKOUT_ORDER_BUMPS = [
  {
    id: 'celluoff-30',
    title: 'CELLUOFF 30 CÁPSULAS',
    price: 23.9,
    compareAt: 57.9,
    image: 'https://i.ibb.co/8DhXRVDC/image.png',
    description:
      'Com astaxantina, cafeína e L-carnitine age diretamente na redução da celulite e melhora a firmeza e aparência da pele em todos os aspectos.',
  },
  {
    id: 'l-carnitine-90',
    title: 'L-CARNITINE 90 CÁPSULAS',
    price: 27.9,
    compareAt: 59.9,
    image: 'https://i.ibb.co/gZZZy2y1/image.png',
    description:
      '2.000mg de L-Carnitina + CoQ10 que aceleram o metabolismo em até 3x, aumentar a queima de gordura e elevar sua energia diária constante',
  },
  {
    id: 'colageno-verisol',
    ...
    price: 25.9,
    compareAt: 79.9,
    image: 'https://i.ibb.co/Kx028krc/image.png',
    description:
      'Potencializa firmeza, elasticidade e hidratação da pele de dentro para fora. Fórmula completa com colágeno Verisol®, ácido hialurônico, biotina, coenzima Q10 e vitaminas essenciais para resultados ainda mais visíveis.',
  },
] as const;
...
const Checkout = ({ selectedPlan, onBack }: { selectedPlan: any, onBack: () => void }) => {
  ...
  const shippingPrice = shippingMethod === 'sedex' ? 14.92 : 0;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 pt-4">
        <button
          type="button"
          onClick={onBack}
          className="inline-flex items-center gap-1 text-sm font-bold text-gray-600 hover:text-secondary transition-colors"
        >
              ...
              {cepDigits.length === 8 && !cepError && (
                <div className="mt-8 space-y-3">
                  ...
                  >
                    ...
                    <span className="font-black text-secondary text-sm">R$ 14,92</span>
                  </button>
                </div>
              )}
            </div>
                        ...
                        <div className="flex flex-wrap items-baseline justify-between gap-x-2 gap-y-0.5 mb-1">
                          ...
                          <div className="text-right whitespace-nowrap">
                            <span className="block text-[10px] text-gray-400 line-through font-medium">
                              de R$ {bump.compareAt.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </span>
    ...
    <section id="ofertas" className="py-24 bg-secondary/5">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-2xl sm:text-3xl md:text-5xl font-black text-secondary mb-6">ESCOLHA SEU PROTOCOLO</h3>
          <p className="text-gray-600 text-lg">Oferta exclusiva por tempo limitado</p>
        </div>
          ...
          {plans.map((p, i) => (
            ...
            >
              ...
              <button 
                ...
                className="w-full py-4 rounded-2xl font-black text-lg shadow-lg transition-all bg-primary text-white hover:bg-primary-dark shadow-primary/20"
              >
                {p.cta}
              </button>
            </motion.div>
